...
from src.model import InceptionI3d
from src.utils.CustomTracer import CustomTracer
from src.utils.ModelArchInspector import ModelArchInspector
...
def main() -> None:
    ...
    with torch.autocast(device_type="cuda", dtype=torch.float16):
        for model, return_nodes in zip(
            ...
            features: torch.Tensor = feature_extractor(video)["logits"]  # [B, C]
    return None
