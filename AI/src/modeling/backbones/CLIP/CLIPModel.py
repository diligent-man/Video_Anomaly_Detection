...
from .utils import _get_vector_norm

__all__ = ["CLIPModel", "clip"]
...
def clip(weights: str) -> torch.nn.Module:
    return CLIPModel.from_pretrained(weights, use_safetensors=True)
