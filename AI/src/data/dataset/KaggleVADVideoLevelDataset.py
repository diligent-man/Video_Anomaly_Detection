...
__all__ = ["KaggleVADVideoLevelDataset"]


class KaggleVADVideoLevelDataset(Dataset):
    """
    ...
    def __init__(self,
        ...
        self.normal_ds: VideoDataset = VideoDataset(os.path.join(normal_root, "normal"), loader, target=0, **kwargs)
        self.anomaly_ds: VideoFolderDataset = VideoFolderDataset(os.path.join(anomaly_root, "anomaly"), loader, **kwargs)
