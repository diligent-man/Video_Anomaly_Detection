...
# Danh sách video và thư mục tương ứng
videos = {
    ...
    "https://www.youtube.com/watch?v=1eEVwhs4OYA&list=PL3HxEb3s-wfZNiCdU7G0oFnHawBMYpdLv&pp=gAQB": "hiding",
    "https://www.youtube.com/watch?v=AKOnSEDDzDM&list=PL3HxEb3s-wfZx6-GDDSVRSUXqduFUXHAW&pp=gAQB": "loitering",
...
for video_url, action_folder in videos.items():
    ...
    for entry in video_entries:
        ...
        output_filename = f"{crawled}_{action_folder}_{id_str}.mp4"
